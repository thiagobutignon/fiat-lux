...
import { CandlestickGenerator } from '../../src/benchmark/data/use-cases/candlestick-generator';
import { GrammarPatternDetector } from '../../src/benchmark/infrastructure/adapters/grammar-pattern-detector';
