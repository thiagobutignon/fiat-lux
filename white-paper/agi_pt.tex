...
Do sistema AGI ``brinquedinho'' emergiram \textbf{15+ inovações}:
...
Princípios filosóficos ``O Ócio é Tudo'' e ``Você Não Sabe é Tudo'' \textbf{emergiram} da arquitetura, não foram programados. Sugere descoberta de ``leis naturais da inteligência''.
