...
From the ``toy'' AGI system emerged \textbf{15+ innovations}:
...
Philosophical principles ``Idleness Is All'' and ``Not Knowing Is All'' \textbf{emerged} from architecture, were not programmed. Suggests discovery of ``natural laws of intelligence''.
