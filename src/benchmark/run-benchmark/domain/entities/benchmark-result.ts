...
export class BenchmarkResult {
  ...
  compareTo(other: BenchmarkResult): string {
    ...
    const accuracyDiffNum = (this.metrics.accuracy - other.metrics.accuracy) * 100;
    const accuracyDiff = accuracyDiffNum.toFixed(1);
...
- Accuracy: ${accuracyDiffNum > 0 ? '+' : ''}${accuracyDiff}%
