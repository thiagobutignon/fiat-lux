...
import { BenchmarkResult, BenchmarkMetrics } from '../entities/benchmark-result';
import { SignalType, TradingSignal } from '../../../_shared/domain/entities/trading-signal';
import { ErrorAnalysis } from '../../../analyze-errors/domain/entities/error-analysis';
import { ErrorAnalysisBuilder } from '../../../analyze-errors/domain/use-cases/error-analysis-builder';
import { TestCase } from '../../../generate-candlestick/domain/use-cases/candlestick-generator';
