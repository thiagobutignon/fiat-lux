...
import { BenchmarkResult, BenchmarkMetrics } from '../../domain/entities/benchmark-result';
import { SignalType, TradingSignal } from '../../domain/entities/trading-signal';
import { ErrorAnalysis } from '../../domain/entities/error-analysis';
import { ErrorAnalysisBuilder } from '../../data/use-cases/error-analysis-builder';
import { TestCase } from '../../data/use-cases/candlestick-generator';
