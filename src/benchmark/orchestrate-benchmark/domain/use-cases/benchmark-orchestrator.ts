...
import { BenchmarkResult } from '../../../run-benchmark/domain/entities/benchmark-result';
import { IPatternDetector } from '../../../run-benchmark/data/protocols/pattern-detector';
import { CandlestickGenerator, TestCase } from '../../../generate-candlestick/domain/use-cases/candlestick-generator';
import { GrammarPatternDetector } from '../../../detect-pattern/infrastructure/adapters/grammar-pattern-detector';
import {
  createGPT4Detector,
  createClaudeDetector,
  createLlamaDetector
} from '../../../detect-pattern/infrastructure/adapters/llm-pattern-detector';
import { LSTMPatternDetector } from '../../../detect-pattern/infrastructure/adapters/lstm-pattern-detector';
import { GeminiPatternDetector } from '../../../detect-pattern/infrastructure/adapters/gemini-pattern-detector';
import { LocalLlamaDetector } from '../../../detect-pattern/infrastructure/adapters/local-llama-detector';
import { VllmPatternDetector } from '../../../detect-pattern/infrastructure/adapters/vllm-pattern-detector';
import { LlamaCppDetector } from '../../../detect-pattern/infrastructure/adapters/llamacpp-detector';
