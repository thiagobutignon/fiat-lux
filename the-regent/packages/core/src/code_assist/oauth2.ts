...
const OAUTH_CLIENT_ID = process.env.GOOGLE_OAUTH_CLIENT_ID ||
  'YOUR_GOOGLE_OAUTH_CLIENT_ID_HERE'; // Set via environment variable

// OAuth Secret value used to initiate OAuth2Client class.
// Removed hardcoded value - use environment variable instead for security
const OAUTH_CLIENT_SECRET = process.env.GOOGLE_OAUTH_CLIENT_SECRET ||
  'YOUR_GOOGLE_OAUTH_CLIENT_SECRET_HERE'; // Set via environment variable
